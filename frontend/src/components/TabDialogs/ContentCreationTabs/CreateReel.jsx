...
const CreateReel = () => {
  return (
    <TabsContent value="Create Reel">
      <div className="font-bold mb-5">Create a new Reel for users</div>
      <Input
        type="text"
        label="Write Caption of Reel"
        placeholder="Enter caption for your new reel "
        error={null}
      />
      <div className="flex justify-between">
        ...
        <div className="py-5 relative text-center">
          <img
            ...
            alt=""
          />
          {/* <span className="text-sm font-bold">Attach Reel video </span> */}
